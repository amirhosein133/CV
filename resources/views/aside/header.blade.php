                    ...
                    <div
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                             class="menu-item here show menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3 {{request()->is('article', 'article/*') ? ' btn-primary text-white ' : '' }}">
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                             class="menu-item here show menu-lg-down-accordion me-lg-1" >
												<span class="menu-link py-3  {{request()->is('project', 'project/*') ? ' btn-primary text-white ' : '' }}">
                            ...
                            <div
                                class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menurounded-0 py-lg-4 w-lg-200px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{route('project.index')}}">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                             class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3 {{request()->is('course', 'course/*') ? ' btn-primary text-white ' : '' }}">
                            ...
                            <div
                                class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menurounded-0 py-lg-4 w-lg-200px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{route('course')}}">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                        ...
                        <div class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-1 {{request()->is('aboutMe', 'aboutMe/*') ? ' btn-primary text-white ' : '' }}">
                                                     <a class="menu-link py-3" href="{{route('aboutMe')}}">
                                                         <span class="menu-title">درباره ما</span></a>
													<span class="menu-arrow d-lg-none"></span>
												</span>
                        </div>
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                             class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3 {{request()->is('updateProfile', 'updateProfile/*') ? ' btn-primary text-white ' : '' }}">
                            ...
                            <div
                                class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menurounded-0 py-lg-4 w-lg-200px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="{{route('updateProfile' , auth()->id())}}">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                        <span class="menu-title">تغییر اطلاعات کاربر</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                 class="menu-item menu-lg-down-accordion me-lg-1">
												<span class="menu-link py-3">
													<span class="menu-title">پنل ادمین</span>
													<span class="menu-arrow d-lg-none"></span>
												</span>
                                <div
                                    class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menurounded-0 py-lg-4 w-lg-200px">
                                    <div class="menu-item">
                                        <a class="menu-link py-3" href="{{route('admin.index')}}">
                                            ...
                                            <span class="menu-title">ورود به پنل ادمین</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
