    ...
    <div class="card mb-5 mb-xl-8 text-right">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">کاربران</span>
        ...
        <div class="card-body py-3">
            ...
            <div class="table-responsive">
                ...
                <table class="table align-middle gs-0 gy-4">
                    ...
                    <tr class="fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-200px">وضعیت فعال بودن کاربر</th>
            ...
            <td>
                @if($user->activation == 1)
                    <span class="badge badge-light-success fs-8 fw-bolder my-2">فعال</span>
                @else
                    <span class="badge badge-light-danger fs-8 fw-bolder my-2">غیرفعال</span>
                @endif
            </td>
            <td>
                <a href="{{route('admin.user.show' , $user->id)}}"
