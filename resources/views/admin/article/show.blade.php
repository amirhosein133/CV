            ...
            <div class="position-relative mb-17">
                ...
                <div class="overlay overlay-show">
                    ...
                    <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-500px"
                         style="background-image: url('{{ asset($article->medias[0]->url)}}')">
                    </div>
                    <!--end::Image-->
                    <!--begin::layer-->
                ...
                <div class="position-absolute text-white mb-8 ms-10 bottom-0">
                    <!--begin::Title-->
                    <h3 class="text-white fs-2qx fw-bolder mb-3 m">{{$article->name}}</h3>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
            </div>
                ...
                <div class="card bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-7">
                            ...
                            <!--end::Title-->
                            <!--begin::Text-->
                            <p class="fw-bold fs-6 text-gray-600 text-right">{{$article->description}}</p>
                            <!--end::Text-->
                        </div>
                        <!--end::Top-->
                        <!--begin::Item-->
                        <div class="mb-8">
                            ...
                            <div class="my-2">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <!--end::Bullet-->
                                    <!--begin::Label-->
                                    <div class="text-gray-600 fw-bold fs-6">نام سازنده : {{$article->user->name}}</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Row-->
                                <!--begin::Row-->
                        ...
                        <div class="mb-8">
                            <!--begin::Title-->
                            <h4 class="text-gray-700 w-bolder mb-0 text-right">اطلاعات مقاله</h4>
                            <!--end::Title-->
                            <!--begin::Section-->
                            <div class="my-2">
                                <!--begin::Row-->
                                <div class="m-0">
                                    ...
                                    <div class="d-flex align-items-center collapsible py-3 toggle mb-0 collapsed"
                                        ...
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <h4 class="text-gray-700 fw-bolder cursor-pointer mb-0">دسته بندی مقاله</h4>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Heading-->
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="text-gray-600 fw-bold fs-6">تعداد لایک های
                                                        مقاله: {{count($article->favorites)}}</div>
                                                    <!--end::Label-->
                                                </div>
