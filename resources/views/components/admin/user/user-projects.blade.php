<div class="row d-flex flex-wrap flex-stack mb-6">
    <!--begin::Title-->
    <h3 class="fw-bolder my-2 text-right">پروژه ها
        <span class="fs-6 text-gray-400 fw-bold ms-1">{{count($projects)}}</span>
    </h3>
    ...
    @else
        @foreach($projects as $item)
            <div class="col-md-6 col-xl-5">
                <!--begin::Card-->
                <a href="{{route('project.show' , $item)}}" class="card border-hover-primary">
                    <!--begin::Card header-->
